...
def modify_last_two_lines(filename, current_x):
    ...
    # 修改最后两行
    lines[-3] = f"#cylinder: 1.0 {current_x:.1f} 0 1.0 {current_x:.1f} 0.0025 0.25 PVC\n"
    lines[-2] = f"#cylinder: 1.0 {current_x:.1f} 0 1.0 {current_x:.1f} 0.0025 0.2 free_space\n"

    # 构建新的文件名
    new_filename = f"randow0p2zaoshengPVC2.35BelowAddjicengAndliqing10{current_x:.1f}.in"
...
base_filename = "../实验组非金属材料/randow0p2zaoshengPVC2.35BelowAddjicengAndliqing1005.in"
start_x = 0.5
end_x = 1.8
step = 0.1
