...
def modify_last_two_lines(filename, current_x):
    ...
    # 修改最后两行
    lines[-3] = f"#cylinder: 1.0 {current_x:.1f} 0 1.0 {current_x:.1f} 0.0025 0.25 ZhuTie\n"
    lines[-2] = f"#cylinder: 1.0 {current_x:.1f} 0 1.0 {current_x:.1f} 0.0025 0.2 free_space\n"

    # 构建新的文件名
    new_filename = f"randow0p2zaoshengZhuTie2.35BelowAddjicengAndliqing1005{current_x:.1f}.in"
...
base_filename = "../实验组/randow0p2zaoshengZhuTie2.35BelowAddjicengAndliqing1005.in"
start_x = 0.5
end_x = 1.8
step = 0.1
