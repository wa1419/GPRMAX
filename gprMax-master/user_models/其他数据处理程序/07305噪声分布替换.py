...
# 定义文件路径
base_path = r'D:\Dpanfilefoder\pythonProject\gprMax-master\user_models\5×2×14×3×2\2×8×2×3×14\0101010101\02'
input_file_path = os.path.join(base_path, '0201010101.in')
...
if os.path.exists(input_file_path):
    ...
    for key, (new_material, new_cylinder) in new_files.items():
        if len(lines) >= 59:
            lines[25] = new_material
            lines[58] = new_cylinder

        new_file = f'02{key}010101.in'
